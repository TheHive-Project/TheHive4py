...
class TestObservableTypeEndpoint:
    ...
    def test_find(self, thehive: TheHiveApi, test_observable_type: OutputObservableType):
    ...
    def test_delete(self, thehive: TheHiveApi, test_observable_type: OutputObservableType):
