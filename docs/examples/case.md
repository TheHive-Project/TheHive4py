...
TheHive considers the [MITRE ATT&CK](https://attack.mitre.org/) framework as a first class citizen and fully suports its tactics, techniques and procedures (TTPs for short), therefore it's possible to enrich cases with procedures from their catalog.
